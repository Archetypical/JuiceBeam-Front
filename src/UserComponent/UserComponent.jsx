    ...
    <form name="form" onSubmit={handleSubmit}>
      <div className="form-group overflow-hidden">
        <div className="user-box slideInLeft first">
          <label id="field-title">Username</label>
          <input
            type="text"
            name="username"
            value={username}
      ...
      <div className="form-group overflow-hidden">
        <div className="user-box slideInLeft second">
          <label id="field-title">Password</label>
          <input
            type="password"
            name="password"
            value={password}
            onChange={handleChange}
            className={
              "form-control mb-0" + (submitted && !password ? " is-invalid" : "")
            }
          />
          {submitted && !password && (
  ...
  return (
    <form name="form" onSubmit={handleSubmit}>
      <div className="form-group mb-0 overflow-hidden">
        <div className="user-box slideInLeft first">
          <label id="field-title">Email Address</label>
          <input
            type="text"
            name="email"
            value={user.email}
